  ...
  return (
    <footer className="bg-neutral-900 text-neutral-300 pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        {/* Top Section: Navigation, Info, Contact */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-x-16 lg:gap-x-24 border-b border-[#333333] pb-16 mb-8">
          <div className="flex flex-col gap-4 pr-0 md:pr-8 md:border-r border-[#333333]">
            ...
            >
              gradify<span className="text-[#BFFF00]">@</span>gmail.com
            </Link>
          </div>
          {/* Navigation Column */}
          <div className="flex flex-col gap-4 pr-0 md:pr-8 md:border-r border-[#333333]">
            <h3 className="text-sm text-gray-500 font-mono">// Navigation</h3>
            <Link
              href="#"
            ...
            <Link href="#faq" className="text-lg font-medium text-gray-500">
              FAQs
            </Link>
          </div>
        ...
        {/* Bottom Section: Branding, Copyright, Scroll to Top */}
        <div className="flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
          ...
          <div className="flex items-center gap-2 whitespace-nowrap">
            ...
            <span className="text-white">Gradify</span>
            <button
              onClick={scrollToTop}
